...
var import_placeholder_preview = __toESM(require("./placeholder-preview"));
var import_navigation_menu_selector = __toESM(require("../navigation-menu-selector"));
function NavigationPlaceholder({
  ...
  const { isResolvingMenus, hasResolvedMenus } = (0, import_use_navigation_entities.default)();
