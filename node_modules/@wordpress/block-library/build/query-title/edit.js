...
var import_use_archive_label = require("./use-archive-label");
var import_use_post_type_label = require("./use-post-type-label");
...
function QueryTitleEdit({
  ...
  const blockProps = (0, import_block_editor.useBlockProps)({
    className: (0, import_clsx.default)("wp-block-query-title__placeholder", {
