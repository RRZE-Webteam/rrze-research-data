...
const { useLayoutClasses } = (0, import_lock_unlock.unlock)(import_block_editor.privateApis);
const { hasOverridableBlocks } = (0, import_lock_unlock.unlock)(import_patterns.privateApis);
...
function ReusableBlockControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    canOverrideBlocks && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_block_editor.BlockControls, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.ToolbarGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
function ReusableBlockEdit({
  ...
  const { onNavigateToEntityRecord, hasPatternOverridesSource } = (0, import_data.useSelect)(
    (select) => {
