...
function TableEdit({
  ...
  const renderedSections = sections.map((name) => /* @__PURE__ */ jsx(TSection, { name, children: attributes[name].map(({ cells }, rowIndex) => /* @__PURE__ */ jsx("tr", { children: cells.map(
    ({
      content,
      tag: CellTag,
      scope,
