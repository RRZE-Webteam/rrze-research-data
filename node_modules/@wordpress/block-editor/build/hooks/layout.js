...
var import_use_settings = require("../components/use-settings");
var import_layouts = require("../layouts");
...
function useLayoutClasses(blockAttributes = {}, blockName = "") {
  ...
  const hasGlobalPadding = (0, import_data.useSelect)(
    (select) => {
      return (usedLayout?.inherit || usedLayout?.contentSize || usedLayout?.type === "constrained") && select(import_store.store).getSettings().__experimentalFeatures?.useRootPaddingAwareAlignments;
    },
...
const withLayoutStyles = (0, import_compose.createHigherOrderComponent)(
