...
var import_use_block_display_information = __toESM(require("../components/use-block-display-information"));
...
function PositionPanelPure({
  ...
  return import_element.Platform.select({
    web: options.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_inspector_controls.default, { group: "position", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
