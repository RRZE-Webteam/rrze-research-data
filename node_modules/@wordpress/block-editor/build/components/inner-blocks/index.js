...
var import_button_block_appender = __toESM(require("./button-block-appender"));
var import_default_block_appender = __toESM(require("./default-block-appender"));
var import_use_nested_settings_update = __toESM(require("./use-nested-settings-update"));
var import_use_inner_block_template_sync = __toESM(require("./use-inner-block-template-sync"));
var import_use_block_context = __toESM(require("./use-block-context"));
var import_block_list = require("../block-list");
var import_block_context = require("../block-context");
var import_context = require("../block-edit/context");
var import_use_block_sync = __toESM(require("../provider/use-block-sync"));
var import_store = require("../../store");
var import_use_block_drop_zone = __toESM(require("../use-block-drop-zone"));
...
const BlockListItemsMemo = (0, import_element.memo)(import_block_list.BlockListItems);
...
const ForwardedInnerBlocks = (0, import_element.forwardRef)((props, ref) => {
