...
var import_block_select_button = __toESM(require("./block-select-button"));
var import_block_draggable = __toESM(require("../block-draggable"));
var import_context = require("./context");
const ListViewBlockContents = (0, import_element.forwardRef)(
  ({
    onClick,
    onToggleExpanded,
    block,
