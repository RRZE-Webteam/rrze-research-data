...
var import_link_viewer = __toESM(require("./link-viewer"));
var import_link_editor = __toESM(require("./link-editor"));
var import_lock_unlock = require("../../lock-unlock");
const { __experimentalPopoverLegacyPositionToPlacement } = (0, import_lock_unlock.unlock)(
  import_components.privateApis
);
const DEFAULT_PLACEMENT = "bottom";
const URLPopover = (0, import_element.forwardRef)(
  ({
    additionalControls,
    children,
    renderSettings,
