...
var import_tips = __toESM(require("./tips"));
var import_preview_panel = __toESM(require("./preview-panel"));
var import_block_types_tab = __toESM(require("./block-types-tab"));
var import_block_patterns_tab = __toESM(require("./block-patterns-tab"));
var import_pattern_category_previews = require("./block-patterns-tab/pattern-category-previews");
var import_media_tab = require("./media-tab");
var import_search_results = __toESM(require("./search-results"));
var import_use_insertion_point = __toESM(require("./hooks/use-insertion-point"));
var import_store = require("../../store");
var import_tabbed_sidebar = __toESM(require("../tabbed-sidebar"));
var import_use_zoom_out = require("../../hooks/use-zoom-out");
...
const PrivateInserterMenu = (0, import_element.forwardRef)(InserterMenu);
