...
var import_letter_spacing_control = __toESM(require("../letter-spacing-control"));
var import_text_alignment_control = __toESM(require("../text-alignment-control"));
var import_text_transform_control = __toESM(require("../text-transform-control"));
var import_text_decoration_control = __toESM(require("../text-decoration-control"));
var import_writing_mode_control = __toESM(require("../writing-mode-control"));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    Wrapper,
    {
      ...
      children: [
        ...
        hasTextAlignmentControl && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_components.__experimentalToolsPanelItem,
          {
