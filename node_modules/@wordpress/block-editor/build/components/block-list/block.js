...
var import_block_edit = __toESM(require("../block-edit"));
var import_block_invalid_warning = __toESM(require("./block-invalid-warning"));
var import_block_crash_warning = __toESM(require("./block-crash-warning"));
var import_block_crash_boundary = __toESM(require("./block-crash-boundary"));
var import_block_html = __toESM(require("./block-html"));
var import_use_block_props = require("./use-block-props");
var import_store = require("../../store");
var import_layout = require("./layout");
var import_private_block_context = require("./private-block-context");
...
const applyWithDispatch = (0, import_data.withDispatch)((dispatch, ownProps, registry) => {
  const {
  ...
  const selectedProps = (0, import_data.useSelect)(
    (select) => {
      ...
      const previewContext = {
        ...
        isReusable: (0, import_blocks.isReusableBlock)(blockType),
