...
var import_mover_description = require("./mover-description");
...
const BlockMoverButton = (0, import_element.forwardRef)(
...
const BlockMoverUpButton = (0, import_element.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlockMoverButton, { direction: "up", ref, ...props });
});
const BlockMoverDownButton = (0, import_element.forwardRef)((props, ref) => {
