...
var import_advanced_controls_panel = __toESM(require("./advanced-controls-panel"));
var import_position_controls_panel = __toESM(require("./position-controls-panel"));
var import_inspector_controls = __toESM(require("../inspector-controls"));
const SettingsTab = ({ showAdvancedControls = false }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
