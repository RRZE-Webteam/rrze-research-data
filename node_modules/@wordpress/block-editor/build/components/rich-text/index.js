...
var import_autocomplete = require("../autocomplete");
var import_block_edit = require("../block-edit");
var import_context = require("../block-edit/context");
var import_format_toolbar_container = __toESM(require("./format-toolbar-container"));
var import_store = require("../../store");
var import_use_mark_persistent = require("./use-mark-persistent");
var import_use_format_types = require("./use-format-types");
var import_event_listeners = require("./event-listeners");
var import_format_edit = __toESM(require("./format-edit"));
...
const keyboardShortcutContext = (0, import_element.createContext)();
keyboardShortcutContext.displayName = "keyboardShortcutContext";
const inputEventContext = (0, import_element.createContext)();
...
const PrivateRichText = (0, import_with_deprecations.withDeprecations)(
...
const PublicForwardedRichTextContainer = (0, import_element.forwardRef)((props, ref) => {
  const context = (0, import_block_edit.useBlockEditContext)();
